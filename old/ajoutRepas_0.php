...
if (isset($_POST["ajouter"])) {
    ...
    //     //$errors['image'] = "Entrez l'URL de l'image svp !";
    ...
    if (!move_uploaded_file($_FILES['image']['tmp_name'], './' . $chemin_image)) {
        $errors['uploadImage'] = 'L\'image téléchargée avec erreur';
  ...
  <main class="container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="input-field">
        ...
        <!-- <input type="text" name="image" id="image" placeholder="Veuillez entrer l'url de l'image " value="<?=$image ?? ''?>"> -->
