...
// echo '<br>';
// echo '<pre>';
// print_r($users[$userIndex]['repas'][$repasIndex]);
// echo '</pre>';
...
// die;
    ...
    if (empty(array_filter($errors, fn($e) => $e !== ''))) {
        ...
        // $users[$userIndex]['repas'] = [...$users[$userIndex]['repas'][$repasIndex] ?? [], [
  ...
  <main class="container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <!-- <div class="input-field">
        ...
        <input type="file" id="image" name="image" accept="image/*" value="<?=$repas['cheminImage'] ?? ''?>">        
        <?php if ($errors['image']): ?>
